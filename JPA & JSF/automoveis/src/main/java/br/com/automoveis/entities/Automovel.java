package br.com.automoveis.entities;
...
import br.com.automoveis.validation.MaxAnoAtualMais;

@NamedQueries({ @NamedQuery(name = Automovel.LISTAR_DESTAQUES, query = "select a from Automovel a", hints = {
...
public class Automovel {
	...
	@Min(1900)
	@MaxAnoAtualMais(message = "O Valor máximo do ano de fabricação é {0}")
